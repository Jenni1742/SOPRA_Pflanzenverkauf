...
@Controller
public class PlantDetailWishlistController {
    @Autowired
    ...
    @GetMapping("/plantDetailWishlist/{id}")
    public String showPlantDetailWishlist(@PathVariable("id") Integer plantId, Model model) {
        ...
        if (plant == null) {
            ...
            return "plantDetailWishlist";
        } else {
            return "error/errorPlantDetails";
        }
    }

    @PostMapping(path = "/plantDetailWishlist/{id}")
    public String addToWishlist(@PathVariable("id") Integer plantId,
        ...
        return "redirect:/plantDetailWishlist/{id}";
    }

    @PostMapping(path = "/plantDetailWishlist/delete/{id}")
